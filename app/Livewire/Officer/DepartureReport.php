...
use App\Exports\DepartureReportsByDateExport;
...
class DepartureReport extends Component
{
    ...
    public function exportByDateRange()
    {
        ...
        return Excel::download(
            new DepartureReportsByDateExport($startDate, $endDate, $this->selectedVessel, $selectedIds),
            $filename
        );
    }
    ...
    public function exportSelected()
    {
        ...
        if (count($this->selectedReports) === 1) {
            ...
            $filename = 'departure_report_' . $report->vessel->name . '_' . Carbon::parse($report->created_at)->timezone('Asia/Manila')->format('Y-m-d') . '.xlsx';
