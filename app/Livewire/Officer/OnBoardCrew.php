...
class OnBoardCrew extends Component
{
    ...
    public function exportByDateRange()
    {
        ...
        return Excel::download(
            new CrewMonitoringPlanReportsByDateExport($startDate, $endDate, $this->viewing, $this->selectedVessel, $selectedIds),
            $filename
        );
    }
    ...
    public function render()
    {
        ...
        return view('livewire.officer.on-board-crew', [
            'reports' => $reports,
            'pages' => $this->pages,
