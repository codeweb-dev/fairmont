...
class PortOfCallReport extends Component
{
    ...
    public function exportByDateRange()
    {
        ...
        $reportType = 'port_of_call_report';
        ...
        return Excel::download(
            new PortOfCallReportsByDateExport($startDate, $endDate, $this->selectedVessel, $selectedIds),
            $filename
        );
    }
    ...
    private function exportMultipleReports()
    {
        ...
        $zipFileName = 'port-of-call_reports_export_' . $vesselName . '_' . $reportDate . '.zip';
        ...
        foreach ($this->selectedReports as $index => $reportId) {
            ...
            if ($report) {
                ...
                $baseFilename = 'port_of_call_report_' . $vesselName . '_' . $reportDate;
