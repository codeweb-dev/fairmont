...
class TableAllFastReport extends Component
{
    ...
    public function exportByDateRange()
    {
        ...
        $filename = 'all_fast_reports_' . now()->format('Y-m-d_H-i-s') . '.xlsx';
    ...
    public function exportSelected()
    {
        ...
        if (count($this->selectedReports) === 1) {
            ...
            $filename = 'all_fast_report_' . $report->vessel->name . '_' . Carbon::parse($report->created_at)->timezone('Asia/Manila')->format('M d, Y h:i A') . '_' . '.xlsx';
