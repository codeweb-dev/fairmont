...
class TableBunkeringReport extends Component
{
    ...
    public function exportSelected()
    {
        ...
        if (count($this->selectedReports) === 1) {
            ...
            $filename = 'bunkering_report_' . $report->vessel->name . '_' . Carbon::parse($report->created_at)->timezone('Asia/Manila')->format('M d, Y h:i A') . '_' . '.xlsx';
    ...
    private function exportMultipleReports()
    {
        ...
        $zipFileName = 'bunkering_reports_export_' . now()->format('Y-m-d_H-i-s') . '.zip';
        ...
        foreach ($this->selectedReports as $index => $reportId) {
            ...
            if ($report) {
                ...
                $baseFilename = 'bunkering_report_' . $vesselName;
