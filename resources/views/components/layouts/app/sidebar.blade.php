        ...
        <flux:navlist variant="outline">
            <flux:navlist.group :heading="__('Platform')" class="grid">
                ...
                <flux:navlist.item icon="newspaper" :href="route('dashboard')"
                    :current="request()->routeIs('dashboard')" wire:navigate>{{ __('Report Management') }}
                </flux:navlist.item>

                <flux:navlist.item icon="document-magnifying-glass" :href="route('audits')"
                    :current="request()->routeIs('audits')" wire:navigate>{{ __('Audit Logs') }}</flux:navlist.item>

                <flux:navlist.item icon="trash" :href="route('dashboard')" :current="request()->routeIs('dashboard')"
                    wire:navigate>{{ __('Trash/Deleted Reports') }}</flux:navlist.item>
