        ...
        <flux:fieldset>
            ...
            <div class="space-y-6">
                <div class="grid grid-cols-4 gap-x-4 gap-y-6">
                    ...
                    <flux:select label="Arrival Type" badge="Required" required wire:model.live="port_gmt_offset" x-on:input="scheduleAutoSave">
                    ...
                    <flux:input label="Arrival Port" badge="Required" required wire:model.defer="supplier" x-on:input="scheduleAutoSave" />

                    @if ($port_gmt_offset === 'Pilot Station')
                        <flux:input label="Anchored Hours" badge="Required" required wire:model.defer="call_sign" x-on:input="scheduleAutoSave" />
                        <flux:input label="Drifting Hours" badge="Required" required wire:model.defer="flag" x-on:input="scheduleAutoSave" />
                    @endif
                </div>
            </div>
        </flux:fieldset>
        ...
        <flux:fieldset>
            ...
            <div class="space-y-6">
                <div class="grid grid-cols-4 gap-x-4 gap-y-6">
                    ...
                    <flux:input label="Distance sailed from last port (NM)" wire:model.defer='distance_to_go' x-on:input="scheduleAutoSave" />
                    <flux:input label="Breakdown (Hrs)" wire:model.defer='breakdown' x-on:input="scheduleAutoSave" />
                    <flux:input label="M/E Revs Counter (Noon to Noon)" wire:model.defer='maneuvering_hours' x-on:input="scheduleAutoSave" />
                    <!-- Row 3 -->
                    ...
                    <flux:input label="Slip (%)" wire:model.defer='next_port' x-on:input="scheduleAutoSave" />
