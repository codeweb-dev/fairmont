<form wire:submit.prevent="update">
    <div class="mb-6 flex items-center justify-between w-full">
        <h1 class="text-3xl font-bold">Edit Crew Monitoring Plan Report</h1>

        <div class="flex items-center gap-3">
            <flux:button href="{{ route('table-crew-monitoring-plan-report-on-board-crew') }}" icon:trailing="arrow-uturn-left">
                Go Back
            </flux:button>
        </div>
    </div>
