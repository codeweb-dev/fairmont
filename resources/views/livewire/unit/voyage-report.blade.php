<form wire:submit.prevent="save">
    ...
    <div class="border dark:border-zinc-700 mb-6 border-zinc-200 p-6 rounded-md">
        <flux:fieldset>
            ...
            <div class="space-y-6">
                <div class="grid grid-cols-2 gap-x-4 gap-y-6">
                    <flux:input label="Off Hire Hours (Hrs)" type="number" required wire:model.defer="hire_hours" />
                    <flux:input label="Off Hire Reason" type="input" required wire:model.defer="hire_reason" />
                </div>
            </div>
        </flux:fieldset>
    </div>
        ...
        <flux:fieldset>
            ...
            <div class="space-y-6">
                <div class="grid grid-cols-4 gap-x-4 gap-y-6">
                    <flux:input label="Avg ME RPM" type="number" required wire:model.defer="avg_me_rpm" />
                    <flux:input label="Avg ME kW" type="number" required wire:model.defer="avg_me_kw" />
                    <flux:input label="TDR (Nm)" type="number" required wire:model.defer="tdr" />
                    <flux:input label="TST (Hrs)" type="number" required wire:model.defer="tst" />
                    <flux:input label="Slip (pct)" type="number" required wire:model.defer="slip" />
                </div>
            </div>
        </flux:fieldset>
    </div>
    ...
    <div class="border dark:border-zinc-700 mb-6 border-zinc-200 p-6 rounded-md">
        <flux:fieldset>
            ...
            <div class="space-y-6">
                <div class="grid grid-cols-4 gap-x-4 gap-y-6">
                    <flux:input label="HSFO (MT)" type="number" required wire:model.defer="robs.hsfo" />
                    <flux:input label="VLSFO (MT)" type="number" required wire:model.defer="robs.vlsfo" />
                    <flux:input label="BIO FUEL (MT)" type="number" required wire:model.defer="robs.biofuel" />
                    <flux:input label="LSMGO (MT)" type="number" required wire:model.defer="robs.lsmgo" />
                    <flux:input label="ME CC OIL (LITRES)" type="number" required wire:model.defer="robs.me_cc_oil" />
                    <flux:input label="ME CYL OIL (LITRES)" type="number" required
                        wire:model.defer="robs.mc_cyl_oil" />
                    <flux:input label="GE CC OIL (LITRES)" type="number" required wire:model.defer="robs.ge_cc_oil" />
                    <flux:input label="FW (MT)" type="number" required wire:model.defer="robs.fw" />
                    <flux:input label="FW Produced (MT)" type="number" required wire:model.defer="robs.fw_produced" />
                </div>
            </div>
        </flux:fieldset>
    </div>
    ...
    <div class="border dark:border-zinc-700 mb-6 border-zinc-200 p-6 rounded-md">
        <flux:fieldset>
            ...
            <div class="space-y-6">
                <div class="grid grid-cols-4 gap-x-4 gap-y-6">
                    <flux:input label="HSFO (MT)" type="number" required wire:model.defer="received.hsfo" />
                    <flux:input label="VLSFO (MT)" type="number" required wire:model.defer="received.vlsfo" />
                    <flux:input label="BIO FUEL (MT)" type="number" required wire:model.defer="received.biofuel" />
                    <flux:input label="LSMGO (MT)" type="number" required wire:model.defer="received.lsmgo" />
                    ...
                    <flux:input label="GE CC OIL (LITRES)" type="number" required
                        wire:model.defer="received.ge_cc_oil" />
                    <flux:input label="FW (MT)" type="number" required wire:model.defer="received.fw" />
                    <flux:input label="FW Produced (MT)" type="number" required
        ...
        <flux:fieldset>
            ...
            <div class="space-y-6">
                <div class="grid grid-cols-4 gap-x-4 gap-y-6">
                    ...
                    <flux:input label="FW (MT)" type="number" required wire:model.defer="consumption.fw" />
                    <flux:input label="FW Produced (MT)" type="number" required
