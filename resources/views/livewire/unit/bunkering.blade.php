<form wire:submit.prevent="save">
    ...
    <div class="border dark:border-zinc-700 mb-6 border-zinc-200 p-6 rounded-md">
        <flux:fieldset>
            ...
            <div class="space-y-6">
                <div class="grid grid-cols-4 gap-x-4 gap-y-6">
                    <flux:input type="number" max="9999999.999" step="0.01" label="HSFO Quantity (MT)" wire:model.defer="hsfo_quantity" />
                    ...
                    <flux:input type="number" max="9999999.999" step="0.01" label="BIOFUEL Quantity (MT)" wire:model.defer="biofuel_quantity" />
                    ...
                    <flux:input type="number" max="9999999.999" step="0.01" label="VLSFO Quantity (MT)" wire:model.defer="vlsfo_quantity" />
                    ...
                    <flux:input type="number" max="9999999.999" step="0.01" label="LSMGO Quantity (MT)" wire:model.defer="lsmgo_quantity" />
