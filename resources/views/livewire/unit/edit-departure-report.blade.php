<form wire:submit.prevent="update">
    <div class="mb-6 flex items-center justify-between w-full">
        <h1 class="text-3xl font-bold">Edit Departure Report</h1>
        ...
        <flux:fieldset>
            ...
            <div class="space-y-6">
                <div class="grid grid-cols-4 gap-x-4 gap-y-6">
                    ...
                    <flux:input label="Date/Time (LT)" type="datetime-local" max="2999-12-31" badge="Required"
                        wire:model.defer="all_fast_datetime" required />
