                    ...
                    <flux:dropdown>
                        ...
                        <flux:menu>
                            <flux:menu.radio.group>
                                ...
                                <flux:navmenu.item href="{{ route('kpi-report.edit', $report->id) }}"
                            ...
                            @if ($report->waste)
                                ...
                                <div class="grid grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm">{{ $report->waste->plastics_landed_ashore ?? '' }}
                                        </p>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm">{{ $report->waste->food_total_incinerated ?? '' }}
                                        </p>
                                    </div>
                                    ...
                                    <div>
                                        <flux:label>Total Landed Ashore (m3)</flux:label>
                                        <p class="text-sm">{{ $report->waste->domestic_landed_ashore ?? '' }}
                                        </p>
                                    </div>
                                    <div>
                                        <flux:label>Total Incinerated (m3)</flux:label>
                                    ...
                                    <div>
                                        <flux:label>Total Landed Ashore (m3)</flux:label>
                                        <p class="text-sm">
                                            {{ $report->waste->cooking_oil_landed_ashore ?? '' }}</p>
                                    </div>
                                    <div>
                                        <flux:label>Total Incinerated (m3)</flux:label>
                                        <p class="text-sm">{{ $report->waste->cooking_oil_incinerated ?? '' }}
                                        </p>
                                    </div>
                                    ...
                                    <div>
                                        <flux:label>Total Landed Ashore (m3)</flux:label>
                                        <p class="text-sm">
                                            {{ $report->waste->incinerator_ash_landed_ashore ?? '' }}
                                        </p>
                                    </div>
                                    <div>
                                        <flux:label>Total Incinerated (m3)</flux:label>
                                        <p class="text-sm">
                                            {{ $report->waste->incinerator_ash_incinerated ?? '' }}</p>
                                    </div>
                                    ...
                                    <div>
                                        <flux:label>Total Landed Ashore (m3)</flux:label>
                                        <p class="text-sm">
                                            {{ $report->waste->operational_landed_ashore ?? '' }}</p>
                                    </div>
                                    <div>
                                        <flux:label>Total Incinerated (m3)</flux:label>
                                        <p class="text-sm">{{ $report->waste->operational_incinerated ?? '' }}
                                        </p>
                                    </div>
                                    ...
                                    <div>
                                        <flux:label>Total Landed Ashore (m3)</flux:label>
                                        <p class="text-sm">{{ $report->waste->ewaste_landed_ashore ?? '' }}
                                        </p>
                                    </div>
                                    ...
                                    <div>
                                        <flux:label>Total Incinerated In (m3)</flux:label>
                                        <p class="text-sm">
                                            {{ $report->waste->ewaste_landed_total_incinerated ?? '' }}
                                        </p>
                                    </div>
                                    ...
                                    <div>
                                        <flux:label>Total Landed Ashore (m3)</flux:label>
                                        <p class="text-sm">
                                            {{ $report->waste->cargo_residues_landed_ashore ?? '' }}
                                        </p>
                                    </div>
                                    <div>
                                        <flux:label>Total Disposed at Sea (In m3)</flux:label>
                                        <p class="text-sm">
                                            {{ $report->waste->cargo_residues_disposed_at_sea ?? '' }}
                                        </p>
                                    </div>
                                    <div class="col-span-2">
                                        <flux:separator class="my-3" />
                                    ...
                                    <div>
                                        <flux:label>Total Disposed at Sea (m3)</flux:label>
                                        <p class="text-sm">
                                            {{ $report->waste->total_garbage_disposed_sea ?? '' }}</p>
                                    </div>
                                    <div>
                                        <flux:label>Total Garbage Landed Ashore (m3)</flux:label>
                                        <p class="text-sm">
                                            {{ $report->waste->total_garbage_landed_ashore ?? '' }}</p>
                                    </div>
                                    ...
                                    <div>
                                        <flux:label>Total Landed Ashore (m3)</flux:label>
                                        <p class="text-sm">{{ $report->waste->sludge_landed_ashore ?? '' }}
                                        </p>
                                    </div>
                                    <div>
                                        <flux:label>Total Incinerated (m3)</flux:label>
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm">{{ $report->waste->bilge_discharged_ows ?? '' }}
                                        </p>
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm">{{ $report->waste->fresh_water_generated ?? '' }}
                                        </p>
                                    </div>
                                    <div>
                                        <flux:label>Fresh Water Consumed (m3)</flux:label>
                                        <p class="text-sm">{{ $report->waste->fresh_water_consumed ?? '' }}
                                        </p>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm">{{ $report->waste->deballast_operations ?? '' }}
                                        </p>
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm">{{ $report->waste->ballast_exchange_amount ?? '' }}
                                        </p>
                                    </div>
