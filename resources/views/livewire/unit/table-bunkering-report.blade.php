                    ...
                    <flux:dropdown>
                        ...
                        <flux:menu>
                            <flux:menu.radio.group>
                                ...
                                <flux:navmenu.item href="{{ route('bunkering-report.edit', $report->id) }}"
                            ...
                            @if ($report->assiociated_information)
                                <div class="grid grid-cols-2 gap-4 pt-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm">
                                            {{ $report->assiociated_information->port_delivery }}</p>
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm">{{ $report->assiociated_information->barge_gmt }}
                                        </p>
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm">{{ $report->assiociated_information->anchor_gmt }}
                                        </p>
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm">{{ $report->assiociated_information->pumping_gmt }}
                                        </p>
                                    </div>
                                </div>
                            @endif
