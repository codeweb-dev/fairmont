            ...
            <tr class="hover:bg-white/5 bg-black/5 transition-all" wire:key="vessel-row-{{ $vessel->id }}">
                ...
                <td class="px-3 py-4">
                    <flux:badge size="sm" icon="{{ $vessel->is_active ? 'check' : 'x-mark' }}"
                        color="{{ $vessel->is_active ? 'green' : 'red' }}">
                        {{ $vessel->is_active ? 'Active' : 'Deactivate' }}</flux:badge>
                </td>
                <td class="px-3 py-4">
                    ...
                    <flux:modal name="deactivate-vessel-{{ $vessel->id }}" class="min-w-[22rem]"
                        wire:key="deactivate-vessel-modal-{{ $vessel->id }}">
                        <div class="space-y-6">
                            <div>
                    ...
                    <flux:modal name="assign-user-{{ $vessel->id }}"
                        wire:key="assign-user-vessel-modal-{{ $vessel->id }}">
                    ...
                    <flux:modal name="delete-vessel-{{ $vessel->id }}" class="min-w-[22rem]"
                        wire:key="delete-vessel-modal-{{ $vessel->id }}">
                        <div class="space-y-6">
                            <div>
                    ...
                    <flux:modal name="view-vessel-{{ $vessel->id }}" class="min-w-[24rem] md:w-[32rem]"
                        wire:key="view-vessel-modal-{{ $vessel->id }}">
                        <div class="space-y-6">
                            <div>
                    ...
                    <flux:modal name="edit-vessel-{{ $vessel->id }}" class="min-w-[24rem] md:w-[32rem]"
                        wire:key="edit-vessel-modal-{{ $vessel->id }}">
    ...
    <div class="mt-6 flex items-center justify-between">
        ...
        <div class="flex items-center gap-2">
            ...
            <div class="w-12 overflow-hidden">
                <input type="text" max="{{ $_vessel->lastPage() }}" wire:model.lazy="currentPage"
