                ...
                <flux:modal name="view-audit-{{ $audit->id }}" class="min-w-[24rem] md:w-[32rem]">
                    <div class="space-y-4">
                        ...
                        <div class="space-y-2">
                            ...
                            <pre
                                class="bg-black/10 p-2 rounded text-xs overflow-auto">{{ json_encode($audit->old_values, JSON_PRETTY_PRINT | JSON_UNESCAPED_SLASHES) }}</pre>
                        </div>

                        <div class="space-y-2">
                            <flux:text class="font-bold">New Values:</flux:text>
                            <pre
                                class="bg-black/10 p-2 rounded text-xs overflow-auto">{{ json_encode($audit->new_values, JSON_PRETTY_PRINT | JSON_UNESCAPED_SLASHES) }}</pre>
                        </div>
