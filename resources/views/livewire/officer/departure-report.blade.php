            ...
            <div class="space-y-6">
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-sm">{{ $selectedReport->all_fast_datetime }}</p>
                    </div>
                    <div>
                ...
                @if ($selectedReport->noon_report)
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-sm">
                                {{ $selectedReport->noon_report->eta_next_port ? \Carbon\Carbon::parse($selectedReport->noon_report->eta_next_port)->format('M d, Y h:i A') : '' }}
                            </p>
                        </div>
                        <div>
                            <flux:label>ETA GMT Offset</flux:label>
                            <p class="text-sm">{{ $selectedReport->noon_report->eta_gmt_offset }}</p>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            <flux:label>Next Port</flux:label>
                            <p class="text-sm">{{ $selectedReport->noon_report->next_port_voyage }}</p>
                        </div>
                        <div>
                            <flux:label>Via</flux:label>
                            <p class="text-sm">{{ $selectedReport->noon_report->via }}</p>
                        </div>
                        <div>
                            <flux:label>ETA (LT)</flux:label>
                            <p class="text-sm">
                                {{ $selectedReport->noon_report->eta_lt ? \Carbon\Carbon::parse($selectedReport->noon_report->eta_lt)->format('M d, Y h:i A') : '' }}
                            </p>
                        </div>
                        <div>
                            <flux:label>GMT Offset</flux:label>
                            <p class="text-sm">{{ $selectedReport->noon_report->gmt_offset_voyage }}</p>
                        </div>
                        <div>
                            <flux:label>Distance to go</flux:label>
                            <p class="text-sm">{{ $selectedReport->noon_report->distance_to_go_voyage }}</p>
                        </div>
                        <div>
                            <flux:label>Projected Speed (Kts)</flux:label>
                            <p class="text-sm">{{ $selectedReport->noon_report->projected_speed }}</p>
                        </div>
                    </div>
                @endif
