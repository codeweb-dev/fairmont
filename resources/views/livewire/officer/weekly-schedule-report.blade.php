                            ...
                            @foreach ($report->ports as $pIndex => $port)
                                <div class="border-t pt-4">
                                    ...
                                    <div class="grid grid-cols-3 gap-4 mt-2">
                                        <div><flux:label>Activity</flux:label><p class="text-sm">{{ $port->activity }}</p></div>
                                        <div><flux:label>ETA/ETB</flux:label><p class="text-sm">{{ $port->eta_etb }}</p></div>
                                        <div><flux:label>ETCD</flux:label><p class="text-sm">{{ $port->etcd }}</p></div>
                                        <div><flux:label>Cargo</flux:label><p class="text-sm">{{ $port->cargo }}</p></div>
                                        <div><flux:label>Cargo Qty</flux:label><p class="text-sm">{{ $port->cargo_qty }}</p></div>
                                        <div><flux:label>Remarks</flux:label><p class="text-sm">{{ $port->remarks }}</p></div>
                                    </div>
