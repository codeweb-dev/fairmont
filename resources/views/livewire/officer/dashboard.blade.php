<div class="grid auto-rows-min gap-4 md:grid-cols-5">
    ...
    <div class="relative overflow-hidden rounded-xl border border-neutral-200 dark:border-neutral-700 p-6">
        <div class="flex items-center justify-between w-full">
            ...
            <flux:button href="{{ route('officer-departure-report') }}" icon="arrow-up-right" variant="filled" wire:navigate />
        </div>
    </div>
    ...
    <div class="relative overflow-hidden rounded-xl border border-neutral-200 dark:border-neutral-700 p-6">
        <div class="flex items-center justify-between w-full">
            ...
            <flux:button href="{{ route('officer-arrival-report') }}" icon="arrow-up-right" variant="filled" wire:navigate />
        </div>
    </div>
    ...
    <div class="relative overflow-hidden rounded-xl border border-neutral-200 dark:border-neutral-700 p-6">
        <div class="flex items-center justify-between w-full">
            ...
            <flux:button href="{{ route('officer-bunkering-report') }}" icon="arrow-up-right" variant="filled" wire:navigate />
        </div>
    </div>
    ...
    <div class="relative overflow-hidden rounded-xl border border-neutral-200 dark:border-neutral-700 p-6">
        <div class="flex items-center justify-between w-full">
            ...
            <flux:button href="{{ route('officer-all-fast-report') }}" icon="arrow-up-right" variant="filled" wire:navigate />
        </div>
    </div>
    ...
    <div class="relative overflow-hidden rounded-xl border border-neutral-200 dark:border-neutral-700 p-6">
        <div class="flex items-center justify-between w-full">
            ...
            <flux:button href="{{ route('officer-weekly-schedule-report') }}" icon="arrow-up-right" variant="filled" wire:navigate />
        </div>
    </div>
    ...
    <div class="relative overflow-hidden rounded-xl border border-neutral-200 dark:border-neutral-700 p-6">
        <div class="flex items-center justify-between w-full">
            ...
            <flux:button href="{{ route('officer-voyage-report') }}" icon="arrow-up-right" variant="filled" wire:navigate />
        </div>
    </div>
    ...
    <div class="relative overflow-hidden rounded-xl border border-neutral-200 dark:border-neutral-700 p-6">
        <div class="flex items-center justify-between w-full">
            ...
            <flux:button href="{{ route('officer-kpi-report') }}" icon="arrow-up-right" variant="filled" wire:navigate />
        </div>
    </div>
    ...
    <div class="relative overflow-hidden rounded-xl border border-neutral-200 dark:border-neutral-700 p-6">
        <div class="flex items-center justify-between w-full">
            ...
            <flux:button href="{{ route('officer-port-of-call-report') }}" icon="arrow-up-right" variant="filled" wire:navigate />
        </div>
    </div>
</div>
