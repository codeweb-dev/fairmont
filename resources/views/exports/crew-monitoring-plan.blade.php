    ...
    <table>
        ...
        @foreach ($report->board_crew as $i => $crew)
            ...
            <tr>
                ...
                <td style="width: 250px; text-align: left;">{{ $crew->joining_date ? \Carbon\Carbon::parse($crew->joining_date)->format('M d, Y h:i A') : '' }}
                </td>
            </tr>
            <tr>
                <td style="width: 250px; text-align: left;">Days to contract completion</td>
                <td style="width: 250px; text-align: left;">{{ $crew->contract_completion ? \Carbon\Carbon::parse($crew->contract_completion)->format('M d, Y h:i A') : '' }}
                </td>
            </tr>
            <tr>
                <td style="width: 250px; text-align: left;">Current Date</td>
                <td style="width: 250px; text-align: left;">{{ $crew->current_date ? \Carbon\Carbon::parse($crew->current_date)->format('M d, Y h:i A') : '' }}
                </td>
            </tr>
            <tr>
        ...
        @foreach ($report->crew_change as $i => $change)
            ...
            <tr>
                ...
                <td style="width: 250px; text-align: left;">{{ $change->joiners_boarding ? \Carbon\Carbon::parse($change->joiners_boarding)->format('M d, Y h:i A') : '' }}
                </td>
            </tr>
            <tr>
                <td style="width: 250px; text-align: left;">Date of Off-signers Sign Off</td>
                <td style="width: 250px; text-align: left;">{{ $change->off_signers ? \Carbon\Carbon::parse($change->off_signers)->format('M d, Y h:i A') : '' }}
                </td>
            </tr>
            <tr>
